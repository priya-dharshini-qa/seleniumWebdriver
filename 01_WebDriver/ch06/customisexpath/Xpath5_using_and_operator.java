...
public class Xpath5_using_and_operator {
	...
	public static void main(String[] args) {
		...
		//customise xpath using AND--> //tagname[@attr1='valofattr1' and @attr2='valofattr2']
		driver.findElement(By.xpath("//button[@id='back-shop' and @class='basic back-shop']")).click();
		System.out.println(driver.getTitle());
	}
